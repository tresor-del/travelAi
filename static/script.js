...
function setTrip(departure, arrival, days, details) {
    ...
    document.getElementById("userInput").value = details || "";
}
...
async function sendMessage() {
    ...
    const details = document.getElementById("userInput").value.trim();

    if (!departure && !arrival && !details) {
        showError("Merci de préciser au moins un départ, une arrivée ou des détails.");
        return;
    }
